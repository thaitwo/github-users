...
var App = function () {
  function App() {
    ...
    this.$searchInput = (0, _jquery2.default)('#input');
    this.$homeDisplay = (0, _jquery2.default)('#home-display');
    this.$userCard = (0, _jquery2.default)('#card');
    this.$userInfoContainer = (0, _jquery2.default)('#user-info');
    this.$followersContainer = (0, _jquery2.default)('#followers-container');
    this.$followersList = (0, _jquery2.default)('#user-followers');
    this.$loadButton = (0, _jquery2.default)('.load-more');
  ...
  _createClass(App, [{
    ...
    key: 'activateSearchUserButton',
    value: function activateSearchUserButton() {
      var _this3 = this;

      this.$userSearchButton.on('click', function (event) {
        event.preventDefault();
    ...
    value: function getFollowersData(username) {
      ...
      _jquery2.default.ajax({
        ...
        success: function success(data) {
          ...
          _this4.createFollowersList(data);

          // Hide or show 'load more' button
          _this4.toggleLoadButton(loadCount);
        }
      });
    }
    ...
    value: function createFollowersList(data) {
      ...
      this.$userSearchButton = (0, _jquery2.default)('.search-btn');
    ...
    value: function activateLoadButton(username) {
      ...
      this.$loadButton.on('click', function (event) {
        ...
        _this5.getFollowersData(username, count, loadCount);
      });
    }
  }]);
